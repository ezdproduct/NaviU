...
import { Card, CardTitle, CardDescription } from '@/components/ui/card'; // Import Card components
import { Button } from '@/components/ui/button'; // Import Button component
import { FileQuestion } from 'lucide-react'; // Import FileQuestion icon
        ...
        <div className="bg-gray-50 rounded-2xl shadow-lg p-6 sm:p-8">
            ...
            {!hasCareerData ? (
                <Card className="p-6 text-center border-2 border-dashed border-gray-300 bg-gray-50">
                    ...
                    <CardTitle className="text-xl font-bold text-gray-800 mb-3">Chưa có gợi ý ngành nghề</CardTitle>
                    <CardDescription className="text-lg text-gray-600">
                        Hãy hoàn thành bài test NaviU toàn diện để nhận được các gợi ý ngành nghề phù hợp với bạn!
                    </CardDescription>
